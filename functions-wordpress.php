<?php
/**
 * ProTrabajo - Código para WordPress functions.php
 * INSTRUCCIONES: Copia todo este código y pégalo en functions.php de tu tema
 */

// ============================================
// OPCIÓN SIN ACF PRO - Options Page Manual
// ============================================

// Crear página de opciones para información de contacto
add_action('admin_menu', function() {
    add_menu_page(
        'Información de Contacto',  // Page title
        'Contacto',                  // Menu title
        'manage_options',            // Capability
        'protrabajo-contacto',       // Menu slug
        'protrabajo_contacto_page',  // Callback function
...
function protrabajo_contacto_page() {
    ...
    if (isset($_POST['protrabajo_save_contact']) && check_admin_referer('protrabajo_contact_nonce')) {
        ...
        echo '<div class="notice notice-success is-dismissible"><p><strong>¡Información de contacto guardada!</strong></p></div>';
    }
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" 
                               ...
                               class="regular-text"
                               required>
                        <p class="description">Número de teléfono con código de país (ej: +56 9 1234 5678)</p>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="direccion" 
                                  ...
                                  rows="3" 
                                  class="large-text"
                                  required><?php echo esc_textarea($direccion); ?></textarea>
