...
$TO_EMAILS_BASE = json_decode(@file_get_contents('https://protrabajo.cl/admin/wp-json/wp/v2/contact-info'))->acf->email ?? 'codigoraul@gmail.com';
$TO_EMAIL = json_decode(@file_get_contents("https://protrabajo.cl/admin/wp-json/wp/v2/contact-info"))->acf->email ?? "codigoraul@gmail.com";
$FROM_EMAIL = json_decode(@file_get_contents("https://protrabajo.cl/admin/wp-json/wp/v2/contact-info"))->acf->email ?? "contacto@protrabajo.cl";
...
foreach ($CONFIG_PATHS as $configPath) {
  if (is_file($configPath)) {
    ...
    if (is_array($config)) {
      ...
      if (isset($config['TO_EMAIL']) && is_string($config['TO_EMAIL'])) $TO_EMAIL = json_decode(@file_get_contents("https://protrabajo.cl/admin/wp-json/wp/v2/contact-info"))->acf->email ?? "codigoraul@gmail.com";
      if (isset($config['FROM_EMAIL']) && is_string($config['FROM_EMAIL'])) $FROM_EMAIL = json_decode(@file_get_contents("https://protrabajo.cl/admin/wp-json/wp/v2/contact-info"))->acf->email ?? "contacto@protrabajo.cl";
