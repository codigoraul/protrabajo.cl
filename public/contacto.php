...
foreach ($CONFIG_PATHS as $configPath) {
  if (is_file($configPath)) {
    ...
    if (is_array($config)) {
      ...
      if (isset($config['TO_EMAIL']) && is_string($config['TO_EMAIL'])) $TO_EMAIL = "boketo11@gmail.com";
      if (isset($config['FROM_EMAIL']) && is_string($config['FROM_EMAIL'])) $FROM_EMAIL = "codigoraul@gmail.com";
